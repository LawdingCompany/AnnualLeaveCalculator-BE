package com.lawding.leavecalc.dictionary.category.controller;
...
import com.lawding.leavecalc.dictionary.category.service.DictionaryCategoryService;
...
public class DictionaryCategoryController {
    ...
    public ResponseEntity<ApiResponse<List<DictionaryCategoryResponse>>> getAllDictionaryCategories() {
        log.info("[req] GET /admin/dictionary-categories - 사전 카테고리 전체 리스트 요청 for 관리자");
    ...
    public ResponseEntity<ApiResponse<Void>> createDictionaryCategory(
        ...
        log.info("[req] POST /admin/dictionary-categories - 사전 카테고리 생성 요청 for 관리자");
    ...
    public ResponseEntity<ApiResponse<Void>> updateDictionaryCategory(
        ...
        @RequestBody @Valid DictionaryCategoryRequest request) {
        log.info("[req] PUT /admin/dictionary-categories/[id] - 사전 카테고리({}) 수정 요청", id);
    ...
    public ResponseEntity<ApiResponse<Void>> deleteDictionaryCategory(
        @PathVariable Long id){
        log.info("[req] DELETE /admin/dictionary-categories/[id] - 사전 카테고리({}) 삭제 요청", id);
