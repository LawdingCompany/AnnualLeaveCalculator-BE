...
public enum ErrorCode {
    ...
    MISSING_X_PLATFORM_HEADER(1003, HttpStatus.BAD_REQUEST, "필수 헤더 X-Platform 이 누락되었습니다."),   // ⬅️ 추가
    INVALID_PLATFORM_HEADER(1004, HttpStatus.BAD_REQUEST, "X-Platform 값이 유효하지 않습니다."),        // ⬅️ 추가
