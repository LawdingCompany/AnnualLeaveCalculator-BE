package com.lawding.dictionary.controller;

import com.lawding.dictionary.entity.Dictionary;
import com.lawding.dictionary.service.DictionaryService;
import com.lawding.dictionary.dto.response.DictionaryResponse;
import com.lawding.global.common.dto.response.ApiResponse;
import com.lawding.global.common.dto.response.PageResponse;
...
public class DictionaryController {
    ...
    public ResponseEntity<ApiResponse<List<DictionaryResponse>>> getActiveDictionaries() {
        log.info("[req] GET /dictionaries - 연차 백과사전 전체 리스트 요청");
    ...
    public ResponseEntity<ApiResponse<DictionaryResponse>> getActiveDictionary(
        ...
        log.info("[req] GET /dictionaries/[id] - 연차 백과사전 항목({}) 요청", id);
        return ResponseEntity.ok(
            ApiResponse.ok(
    ...
    public ResponseEntity<ApiResponse<PageResponse<DictionaryResponse>>> searchDictionaries(
        ...
        log.info("[req] GET /dictionaries/search?keyword=[]&page=[]&size=[] - 연차 백과사전 검색 키워드 = {}, 페이지 = {}, 크기 = {}",
            keyword, page, size);
